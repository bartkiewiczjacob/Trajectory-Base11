function [x,r] = getContour(Dt, AR, CR, Lc)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Last Updated by Matt Schmale on 09/02/2019
%
%
%  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
initial_parabola_angle = 37.5; %approximation, 80% bell nozzle (referencing G.V.R. Rao angle vs. expansion ratio graph)
final_parabola_angle = 10; %approximation, 80% bell nozzle (referencing G.V.R. Rao angle vs. expansion ratio graph)
...
%CONVERGING PARABOLA PORTION (defined as not including converging section)
x_chamber = [(C2_x - Lc) C2_x];                 %creating x values of chamber line
y_chamber = [chamber_radius chamber_radius];    %creating y values of chamber line
...
Xcoord = [x_chamber(1:end-1) fliplr(Cx_parabola) x_1_5(2:end) x_0_4(2:end) x_parabola(2:end)].';
Ycoord = [y_chamber(1:end-1) fliplr(Cy_parabola) y_1_5(2:end) y_0_4(2:end) y_parabola(2:end)].';
Zcoord = zeros(length(Xcoord), 1);
